...
#include <memory>
#include "../../pokemon/menu/mainmenu.h"
...
QT_MOC_LITERAL(1, 9, 12), // "moveToBattle"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 23), // "on_pushButton_2_clicked"
QT_MOC_LITERAL(4, 47, 12), // "battleReward"
QT_MOC_LITERAL(5, 60, 14) // "battleNoReward"

    },
    "MainMenu\0moveToBattle\0\0on_pushButton_2_clicked\0"
    "battleReward\0battleNoReward"
};
...
void MainMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->battleReward(); break;
        case 3: _t->battleNoReward(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainMenu::moveToBattle)) {
                *result = 0;
                return;
            }
        }
